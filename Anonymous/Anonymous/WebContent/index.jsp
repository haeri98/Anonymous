...
<script type="text/javascript">
	...
	function addChat(no, chatName, chatContent, chatTime){
		var icon = Math.floor(Math.random() * 9) + 1;
		$('#chatList').append('<div class="row">'+
				'<div class="col-lg-10">'+
				'<div class="media">'+
				'<a class="pull-left" href="#">'+
				'<img class="media-object img-circle" src="images/icon'+icon+'.png" width="38" alt="">'+
				'</a>' +
    		...
    		<div class="row">
				<div class="col-xs-12">
					<div class="portlet portlet-default">
						...
						<div id="chat" class="panel-collspae collapse in">
